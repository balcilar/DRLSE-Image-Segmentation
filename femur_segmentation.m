...
phi(325:360,280:325)=-c0;
phi(325:360,480:525)=-c0;
figure(3);
imagesc(phi);
...
for k=1:maxiter
    ...
    if mod(k,50)==1
        ...
        if frm == 1        
            imwrite(imind,cm,'Outputs/femur.gif','gif', 'Loopcount',inf);
        else        
            imwrite(imind,cm,'Outputs/femur.gif','gif','WriteMode','append');
        end
    end
